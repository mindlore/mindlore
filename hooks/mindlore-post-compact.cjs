...
var require_mindlore_common = __commonJS({
  "hooks/src/lib/mindlore-common.cjs"(exports2, module2) {
    ...
    function getLatestDelta2(diaryDir) {
...
CREATE TABLE IF NOT EXISTS episodes (
  ...
  `).all(opts.project, modifier, limit);
    ...
    module2.exports = {
      ...
      getAllDbs,
      getLatestDelta: getLatestDelta2,
      sha256,
      parseFrontmatter,
      extractFtsMetadata,
      readHookStdin,
...
var { findMindloreDir, getLatestDelta, readConfig, hookLog, withTelemetry } = require_mindlore_common();
function main() {
