...
var require_skeleton = __commonJS({
  "dist/scripts/lib/skeleton.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.extractSkeleton = extractSkeleton2;
    ...
    function extractSkeleton2(content, ext) {
...
CREATE TABLE IF NOT EXISTS episodes (
  ...
  `).all(opts.project, modifier, limit);
    ...
    module2.exports = {
      ...
      extractSkeleton: extractSkeleton2,
...
var { findMindloreDir, readHookStdin, getProjectName, hookLog, extractSkeleton, withTelemetrySync } = require_mindlore_common();
function main() {
