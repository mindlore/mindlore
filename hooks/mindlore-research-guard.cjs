...
var require_mindlore_common = __commonJS({
  "hooks/src/lib/mindlore-common.cjs"(exports2, module2) {
    ...
    function openDatabase(dbPath, opts) {
      try {
        const Database = requireDatabase2();
...
CREATE TABLE IF NOT EXISTS episodes (
  ...
  `).all(opts.project, modifier, limit);
    ...
    function extractKeywords2(text, maxKeywords = 8) {
    ...
    module2.exports = {
      ...
      insertFtsRow,
      extractHeadings,
      requireDatabase: requireDatabase2,
      openDatabase,
      getAllMdFiles,
      readConfig,
      detectSchemaVersion,
      ...
      sanitizeKeyword: sanitizeKeyword2,
      // Hook logging (v0.5.1)
      hookLog: hookLog2,
      getRecentHookErrors,
...
var { getAllDbs, requireDatabase, extractKeywords, sanitizeKeyword, hookLog, withTelemetrySync } = require_mindlore_common();
