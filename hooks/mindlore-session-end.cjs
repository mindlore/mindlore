...
var require_secure_io = __commonJS({
  "dist/scripts/lib/secure-io.js"(exports2) {
    ...
    exports2.safeWriteJson = safeWriteJson2;
    ...
    function safeWriteJson2(filePath, obj) {
...
var require_secure_io2 = __commonJS({
  "hooks/src/lib/secure-io.cjs"(exports2, module2) {
    ...
    module2.exports = { safeMkdir, safeWriteFile: safeWriteFile2, safeWriteJson: safeWriteJson2 };
  }
});
...
var require_mindlore_common = __commonJS({
  "hooks/src/lib/mindlore-common.cjs"(exports2, module2) {
    ...
    var { safeMkdir, safeWriteFile: safeWriteFile2 } = require_secure_io2();
    ...
    function globalDir2() {
      ...
      return path2.join(os2.homedir(), MINDLORE_DIR);
    }
    ...
    function getAllDbs() {
      const dbPath = path2.join(globalDir2(), DB_NAME);
...
CREATE TABLE IF NOT EXISTS episodes (
  ...
  created_at TEXT NOT NULL
    ...
    function ensureEpisodesTable2(db) {
    ...
    function insertBareEpisode2(db, entry) {
  ...
  `).all(opts.project, modifier, limit);
    ...
    function resolveWin32Bin2(name) {
    ...
    function cleanupExpiredInjectLog2(db, ttlMs) {
    ...
    module2.exports = {
      ...
      ensureEpisodesTable: ensureEpisodesTable2,
      hasEpisodesTable: hasEpisodesTable2,
      generateEpisodeId,
      insertBareEpisode: insertBareEpisode2,
      queryRecentEpisodes,
      ...
      SHARED_EXPORT_DIRS: SHARED_EXPORT_DIRS2,
      resolveWin32Bin: resolveWin32Bin2,
      ...
      getUnpromotedRawFiles: getUnpromotedRawFiles2,
      ...
      getNominationCounts,
      cleanupExpiredInjectLog: cleanupExpiredInjectLog2
    };
    ...
    function getUnpromotedRawFiles2(baseDir) {
...
var { safeWriteFile, safeWriteJson } = require_secure_io();
var { findMindloreDir, globalDir, getProjectName, openDatabase, ensureEpisodesTable, hasEpisodesTable, insertBareEpisode, insertFtsRow, hookLog, SHARED_EXPORT_DIRS, resolveWin32Bin, withTelemetry, getUnpromotedRawFiles, cleanupExpiredInjectLog } = require_mindlore_common();
