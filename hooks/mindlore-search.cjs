...
var require_mindlore_common = __commonJS({
  "hooks/src/lib/mindlore-common.cjs"(exports2, module2) {
    ...
    function extractHeadings2(content, max) {
      const headings = [];
...
CREATE TABLE IF NOT EXISTS episodes (
  ...
  `).all(opts.project, modifier, limit);
    ...
    module2.exports = {
      ...
      fixVersionTokens,
      insertFtsRow,
      extractHeadings: extractHeadings2,
      requireDatabase,
      ...
      incrementRecallCount: incrementRecallCount2,
      _rotateFile,
      isInsideMindloreDir,
    ...
    function incrementRecallCount2(db, filePath) {
      try {
...
var { getAllDbs, openDatabase, extractHeadings, readHookStdin, readConfig, hookLog, incrementRecallCount, withTelemetry } = require_mindlore_common();
var MAX_RESULTS = 3;
