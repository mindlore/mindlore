...
var require_constants2 = __commonJS({
  "dist/scripts/lib/constants.js"(exports2) {
    ...
    exports2.isSessionCategory = isSessionCategory2;
    exports2.fixVersionTokens = fixVersionTokens;
    exports2.homedir = homedir;
    exports2.getActiveMindloreDir = getActiveMindloreDir2;
    ...
    function isSessionCategory2(category) {
    ...
    function getActiveMindloreDir2() {
...
var require_mindlore_common = __commonJS({
  "hooks/src/lib/mindlore-common.cjs"(exports2, module2) {
    ...
    function getAllDbs() {
      const dbPath = path2.join(globalDir(), DB_NAME2);
    ...
    var SQL_FTS_SESSIONS_INSERT2 = "INSERT INTO mindlore_fts_sessions (path, slug, description, type, category, title, content, tags, quality, date_captured, project) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    function getAllMdFiles2(dir, skip) {
      ...
      for (const entry of entries) {
        ...
        if (entry.isDirectory()) {
          results.push(...getAllMdFiles2(fullPath, skipSet));
...
CREATE TABLE IF NOT EXISTS episodes (
  ...
  `).all(opts.project, modifier, limit);
    ...
    module2.exports = {
      ...
      SKIP_FILES,
      findMindloreDir,
      getActiveMindloreDir: getActiveMindloreDir2,
      getAllDbs,
      getLatestDelta,
      sha256: sha2562,
      ...
      SQL_FTS_SESSIONS_INSERT: SQL_FTS_SESSIONS_INSERT2,
      SESSION_CATEGORIES,
      isSessionCategory: isSessionCategory2,
      fixVersionTokens,
      insertFtsRow: insertFtsRow2,
      extractHeadings,
      requireDatabase,
      openDatabase: openDatabase2,
      getAllMdFiles: getAllMdFiles2,
      readConfig,
      detectSchemaVersion,
...
var { DB_NAME, sha256, openDatabase, getAllMdFiles, parseFrontmatter, extractFtsMetadata, insertFtsRow, readHookStdin, getActiveMindloreDir, getProjectName, resolveProject, hookLog, withTelemetry, SQL_FTS_SESSIONS_INSERT, isSessionCategory, isInsideMindloreDir } = require_mindlore_common();
function main() {
